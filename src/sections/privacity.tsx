...
function Layout({
  icon = '', image = '', title = '', descr = <div />, side = '',
}) {
  const info = (
  ...
  return (
    <div id="privacity" className="" style={{ margin: '100px 0' }}>
